...
const element = React.createElement('h1',{id:"heading"},"Hello world I am here!");
...
//  rendering the element in the root
 ...
 React.createElement('div',{id:"child"},React.createElement('h1',{id:"heading"},"Hello I am grand child h1")));
 ...
 root.render(parent);
    ...
    [React.createElement("h1",{id:"heading"},"I am h1 tag child 1"),React.createElement("h1",{id:"heading"},"I am h1 tag child 2")]));
