...
const Body = () => {
  ...
  const WithPromotionlabelCard = ResCardwithPromotion(ResCard);
  console.log(<WithPromotionlabelCard />);
        ...
        {filterData.map((res) => (
          <Link key={res.info.id} to={"/restaurant/" + res.info.id}>
            {/* <div className=" rounded-2xl"> */}
              ...
              {
                res.info.availability.opened?<WithPromotionlabelCard resData={res} />:<ResCard resData={res} />
              }
              {/* <ResCard resData={res} /> */}
            {/* </div> */}
          </Link>
